...
public class StreamDemo5 {
		public static void main(String[] args) {
					...
					List<Employee> deptWiseDetails = employee.stream().sorted(Comparator.comparing(Employee::getDept1)).collect(Collectors.toList());
				...
				{
					Long sumSal = employees.stream().filter(e->e.getDept1().equals(dept)).collect(Collectors.summarizingInt(Employee::getSalary)).getSum();
					return sumSal;
				}
			}